...
class Event(Base):
    ...
    properties: Mapped[List["EventProperty"]] = relationship(back_populates="event", cascade="all, delete-orphan")
...
class EventProperty(Base):
    ...
    def __repr__(self) -> str:
        return f"EventProperty(id={self.id!r}, name={self.name!r}, value={self.value!r})"
